...
glob_start_timestamp = 1684108800000 - 1 
...
class Processor(object):
    ...
    def run_compute_rsi(self):
        ...
        df = pd.read_sql("select * from stock_price where open_time >= 1684108800000 order by symbol asc, open_time asc", engine)
        ...
        for open_time, symbol, rsi, rsi14 in zip(open_time_ls, symbol_ls, rsi_ls, rsi14_ls):
            ...
            update_cnt += self.db.update_rsi(open_time, symbol, rsi, rsi14)
