...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	//define('CONFIG_UPLOAD_VALID_EXTS', 'gif,jpg,png,txt,flv,swf,wmv'); // 
	define('CONFIG_UPLOAD_VALID_EXTS', 'docx,pdf,ptt,gif,jpg,JPG,png,bmp,tif,zip,sit,rar,gz,tar,htm,html,mov,mpg,avi,asf,mpeg,wmv,aif,aiff,wav,mp3,flv,swf,ppt,rtf,doc,pdf,xls,txt,xml,xsl,dtd');//
	define("CONFIG_VIEWABLE_VALID_EXTS", 'pdf,docx,doc,gif,bmp,txt,jpg,JPG,png,tif,html,htm,js,css,xml,xsl,dtd,mp3,wav,wmv,wma,rm,rmvb,mov,swf,flv');
