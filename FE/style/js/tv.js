...
!function () {
    if (!window.TradingView || !window.TradingView.host || window.TradingView.reoloadTvjs) {
        ...
        d.DependenciesManager = function () {}, d.DependenciesManager.prototype.scripts = {}, d.DependenciesManager.prototype._loaded = function (e) {
            for (var t in this.scripts[e].callbacks)
                this.scripts[e].callbacks[t]();
            this.scripts[e].status = !0, this.scripts[e].callbacks = {}
        }, d.DependenciesManager.prototype.depends = function (e, t, i) {
            for (var o = 0; o < e.length; o++)
                this.scripts[e[o]] && !0 === this.scripts[e[o]].status ? i() : this.scripts[e[o]] && !1 === this.scripts[e[o]].status ? this.scripts[e[o]].callbacks[t] = i : (this.scripts[e[o]] = {
                    status: !1,
            ...
            widgetCode: function () {
                ...
                var y = function (e) {
                    for (var t = [], o = 0; o < e.length; o++) {
                        ...
                        if (d.isArray(n)) {
                            ...
                            "string" == typeof n && t.push(encodeURIComponent(n))
                    }
                    return t.join(",")
                };
                ...
                if (this.options.symbols_description)
                    for (var b in this.options.symbols_description)
                        i += "&" + encodeURIComponent(b) + "=" + encodeURIComponent(this.options.symbols_description[b]);
                ...
                t = "symbols=" + function (t) {
                    for (var i = [], o = 0; o < t.length; o++) {
                        ...
                        if (d.isArray(n)) {
                            ...
                            "string" == typeof n && i.push(encodeURIComponent(n))
                    }
                    return i.join(",")
            ...
            if (n && n.provider && "TradingView" === n.provider)
                if (n.source = e.source, "get" === n.type) {
                    ...
                    i[n.client_id] && i[n.client_id][n.id] && (i[n.client_id][n.id].call(n, n.data), delete i[n.client_id][n.id]);
                else if ("post" === n.type) {
                    if (!o[n.name])
                        return;
                    o[n.name].forEach((function (e) {
            ...
            var t = [];
            for (var i in e)
                e.hasOwnProperty(i) && null != e[i] && t.push(encodeURIComponent(i) + "=" + encodeURIComponent(e[i]));
            return t.join("&")
        };
        var l = function (e, t) {
        ...
        h = function (e, t) {
            for (var i in t)
                "object" == typeof t[i] && e.hasOwnProperty(i) ? h(e[i], t[i]) : e[i] = t[i];
            return e
        };
