...
(function (U, K) {
    ...
    K(f, "Core/Utilities.js", [f["Core/Globals.js"]], function (a) {
        ...
        function B(b, d) {
            ...
            y(b, function (r, h) {
                if (I(b[h], !0) && !b.nodeType && d[h])
                    r = B(b[h], d[h]), Object.keys(r).length && (v[h] = r);
        ...
        function F(d, r, h) {
            var v = a.getStyle || F;
            if ("width" === r)
                return r = Math.min(d.offsetWidth, d.scrollWidth), h = d.getBoundingClientRect && d.getBoundingClientRect().width, h < r && h >= r - 1 && (r = Math.floor(h)), Math.max(0, r - (v(d, "padding-left", !0) || 0) - (v(d, "padding-right", !0) || 0));
            if ("height" === r)
        ...
        b.jQuery && (b.jQuery.fn.highcharts = function () {
            ...
            if (this[0])
                return b[0] ? (new (a[w(b[0]) ? b.shift() : "Chart"])(this[0],
        ...
        f = function () {
            ...
            f.prototype.brighten = function (a) {
                ...
                if (this.stops)
                    ...
                    for (var u = 0; 3 > u; u++)
                        A[u] += w(255 * a), 0 > A[u] && (A[u] = 0), 255 < A[u] && (A[u] = 255);
                return this
            };
            ...
            t.prototype.getTimeTicks =
                    function (e, g, p, t) {
                        ...
                        if (H(g)) {
                            ...
                            g = b.getTime();
                            for (b = 1; g < p; )
                                m.push(g), g = l === c.year ? q.makeTime(v + b * d, 0) : l === c.month ? q.makeTime(v,
        ...
        return function () {
            ...
            a.prototype.step = function (a) {
                ...
                if (e.attr && !e.element)
                    ...
                    this.pos = k.easing((n - this.startTime) / p), this.now = this.start + (this.end - this.start) * this.pos, this.update(), a = !0;
                return a
            };
                ...
                (function (a) {
                    function C(a, u, n) {
                        ...
                        for (a = a.map(function (c) {
                            ...
                            for (g = a.length; g--; )
                                e = a[g], c = (Math.min.apply(0, e.targets) + Math.max.apply(0, e.targets)) /
                                        2, e.pos = f(c - e.size * e.align, 0, u - e.size);
                            g = a.length;
                            for (t = !1; g--; )
                                0 < g && a[g - 1].pos + a[g - 1].size > a[g].pos && (a[g - 1].size += a[g].size, a[g - 1].targets = a[g - 1].targets.concat(a[g].targets), a[g - 1].align = .5, a[g - 1].pos + a[g - 1].size > u && (a[g - 1].pos = u - a[g - 1].size), a.splice(g, 1), t = !0)
                        }
                        k.push.apply(k, q);
                        g = 0;
                        a.some(function (c) {
        ...
        a = function () {
            ...
            a.prototype.align = function (b, c, J) {
                ...
                if (b) {
                    if (this.alignOptions = b, this.alignByTranslate = c, !J || d(J))
                        this.alignTo = m = J || "renderer", x(e, this), e.push(this), J = void 0
                } else
                    b = this.alignOptions, c = this.alignByTranslate,
                            m = this.alignTo;
            ...
            a.prototype.setTextPath = function (b, d) {
                ...
                if (b && d && d.enabled) {
                    ...
                    m && (delete this.updateTransform, delete this.applyTextOutline, this.destroyTextPath(c, b), this.updateTransform(), this.options && this.options.rotation && this.applyTextOutline(this.options.style.textOutline));
                return this
            };
    ...
    K(f, "Core/Renderer/SVG/SVGLabel.js", [f["Core/Renderer/SVG/SVGElement.js"], f["Core/Utilities.js"]], function (a, f) {
        ...
        return function (n) {
            ...
            k.prototype.updateTextPadding = function () {
                ...
                if (a !==
                        e.x || c !== e.y)
                    e.attr("x", a), e.hasBoxWidthChanged && (this.bBox = e.getBBox(!0)), "undefined" !== typeof c && e.attr("y", c);
                e.x = a;
                e.y = c
            };
    ...
    K(f, "Core/Renderer/SVG/TextBuilder.js", [f["Core/Renderer/HTML/AST.js"], f["Core/Globals.js"], f["Core/Utilities.js"]], function (a, f, B) {
        ...
        return function () {
                    ...
                    var f = function (g, k) {
                        ...
                        if (c.ellipsis)
                            ...
                            for (b = []; k.firstChild && k.firstChild !== g; )
                                b.push(k.firstChild), k.removeChild(k.firstChild);
                            for (; h.length; )
                                h.length && !c.noWrap && 0 < d && (m.push(g.textContent || ""), g.textContent = h.join(" ").replace(/- /g, "-")), c.truncate(g, void 0, h, 0 === d ? D || 0 : 0, q, function (b, d) {
            ...
            e.prototype.truncate = function (c, a, e, k, q, f) {
                ...
                if (k + v > q) {
                    for (; h <= b; )
                        l = Math.ceil((h + b) / 2), e && (d = f(e, l)), v = D(l, d && d.length - 1), h === b ? h = b + 1 : v > q ? b = l - 1 : h = l;
        ...
        B = function () {
            ...
            J.prototype.pathToSegments = function (b) {
                for (var d = [], c = [], a = {
                    ...
                    O(c[0]) && v(b[h]) && c.length === a[c[0].toUpperCase()] && b.splice(h, 0, c[0].replace("M", "L").replace("m", "l")), "string" === typeof b[h] && (c.length && d.push(c.slice(0)), c.length = 0), c.push(b[h]);
                d.push(c.slice(0));
                return d
            };
        ...
        f = function () {
            ...
            g.prototype.createLabel = function (c, a, g) {
                ...
                if (c = I(a) && g.enabled ? f.renderer.text(a, c.x, c.y, g.useHTML).add(k.labelGroup) : null)
                    f.styledMode || c.css(e(g.style)), c.textPxLength = c.getBBox().width;
                return c
            };
            ...
            g.prototype.handleOverflow = function (c) {
                ...
                if (b || "justify" !== e.overflow)
                    0 > b && g - l * d < m ? t = Math.round(g /
                            Math.cos(b * C) - m) : 0 < b && g + l * d > f && (t = Math.round((k - g) / Math.cos(b * C)));
                else if (k = g + (1 - l) * d, g - l * d < m ? r = c.x + r * (1 - l) - m : k > f && (r = f - c.x + r * l, n = -1), r = Math.min(D, r), r < D && "center" === a.labelAlign && (c.x += n * (D - r - l * (D - Math.min(d, r)))), d > r || a.autoRotation && (h.styles || {}).width)
                    t = r;
    ...
    K(f, "Core/Axis/Axis.js", [f["Core/Animation/AnimationUtilities.js"], f["Core/Axis/AxisDefaults.js"], f["Core/Color/Color.js"], f["Core/DefaultOptions.js"], f["Core/Foundation.js"], f["Core/Globals.js"],
        ...
        a = function () {
                    ...
                    function (d) {
                        ...
                        if (c.categories)
                            ...
                            for (; m-- && "undefined" === typeof J; )
                                c = Math.pow(l, m + 1), r >= c && 0 === 10 * a % c && null !== g[m] && 0 !== a && (J = d(a / c, -1) + g[m]);
                ...
                m(this, "getSeriesExtremes", null, function () {
                    ...
                    d.series.forEach(function (e) {
                        if (e.visible || !c.options.chart.ignoreHiddenSeries) {
                            ...
                            } else if (e = e.applyExtremes(), b(e.dataMin) && (g = e.dataMin, d.dataMin = Math.min(r(d.dataMin, g), g)), b(e.dataMax) && (m = e.dataMax, d.dataMax = Math.max(r(d.dataMax, m), m)), q(l) && (d.threshold = l), !h.softThreshold || d.positiveValuesOnly)
                                d.softThreshold = !1
                        }
                    })
                });
            ...
            a.prototype.updateNames = function () {
                ...
                0 < d.length && (Object.keys(d.keys).forEach(function (b) {
                    ...
                    if (!d.points || d.isDirtyData)
                        b.max = Math.max(b.max, d.xData.length - 1), d.processData(), d.generatePoints();
            ...
            a.prototype.setAxisTranslation = function () {
                ...
                if (e || a || h) {
                    ...
                    c ? (g = c.minPointOffset, k = c.pointRangePadding) : b.series.forEach(function (d) {
                        ...
                        if (!b.single ||
                                a)
                            d = d.is("xrange") ? !e : e, g = Math.max(g, d && l(m) ? 0 : c / 2), k = Math.max(k, d && "on" === m ? 0 : c)
                    });
                    ...
                    if (this.ordinal && this.ordinal.positions || !((this.max -
                        ...
                        if (this.dateTime)
                            ...
                            for (var l = b = this.tickInterval; l <= 2 * b; )
                                if (c = this.getLinearTickPositions(this.tickInterval, this.min, this.max), this.tickAmount && c.length > this.tickAmount)
                                    this.tickInterval =
                                            C(this, l *= 1.1);
                                else
                                    break;
                    else
                        c = [this.min, this.max], x(19, !1, this.chart);
            ...
            a.prototype.getThresholdAlignment = function (d) {
                ...
                if (b(this.threshold))
                    return d = g((this.threshold - (this.dataMin || 0)) / ((this.dataMax || 0) - (this.dataMin || 0)), 0, 1), this.options.reversed && (d = 1 - d), d
            };
            ...
            a.prototype.zoom = function (b, d) {
                ...
                m(this, "zoom", b, function (b) {
                    var d = b.newMin,
                            h = b.newMax;
                    if (d !== c.min || h !== c.max)
                        c.allowZoomOutside || (q(a) && (d < l && (d = l), d > g && (d = g)), q(e) && (h < l && (h = l), h > g && (h = g))), c.displayBtn = "undefined" !== typeof d || "undefined" !== typeof h, c.setExtremes(d, h, !1, void 0, {
                            trigger: "zoom"
                        });
                    b.zoomed = !0
                });
            ...
            a.prototype.renderTick = function (b, d, c) {
                ...
                if (!this.isLinked || b >= this.min && b <= this.max || this.grid && this.grid.isColumn)
                    a[b] || (a[b] = new I(this, b)), c && a[b].isNew && a[b].render(d,
                            !0, -1), a[b].render(d)
            };
        ...
        (function (a) {
            ...
            var n = function () {
                ...
                a.prototype.getLogTickPositions = function (a, c, k, g) {
                    ...
                    if (.5 <= a)
                        a = Math.round(a), n = e.getLinearTickPositions(a, c, k);
                    else if (.08 <= a) {
                        var x = Math.floor(c),
                                z, m = p = void 0;
                        ...
                        c = this.lin2log(c), k = this.lin2log(k), a = g ? e.getMinorTickInterval() : p.tickInterval, a = H("auto" === a ? null : a, this.minorAutoInterval, p.tickPixelInterval /
        ...
        f = function () {
            ...
            l.prototype.optionsToObject = function (b) {
                ...
                if (q(b) || null === b)
                    ...
                    for (!a && b.length > e && (d = typeof b[0], "string" === d ? h.name = b[0] : "number" === d && (h.x = b[0]), m++); f < e; )
                        a && "undefined" === typeof b[m] || (0 < c[f].indexOf(".") ? l.prototype.setNestedProperty(h, b[m], c[f]) : h[c[f]] = b[m]), m++, f++;
                else
                    "object" === typeof b && (h = b, b.dataLabels && (d._hasPointLabels = !0), b.marker && (d._hasPointMarkers = !0));
                return h
            };
                        ...
                        if (b && k) {
                            ...
                            if (x)
                                if (F)
                                    ...
                                    l && (d.stateMarkerGraphic = F = D.renderer.symbol(l, x.x, x.y, x.width, x.height).add(d.markerGroup), F.currentSymbol = l);
    ...
    K(f, "Core/Pointer.js", [f["Core/Color/Color.js"], f["Core/Globals.js"], f["Core/Tooltip.js"], f["Core/Utilities.js"]], function (a, f, B, H) {
        ...
        a = function () {
            ...
            a.prototype.reset = function (a, c) {
                ...
                if (a)
                    g && f && x(f).length && (g.refresh(f), g.shared && h ? h.forEach(function (b) {
            ...
            a.prototype.runPointActions = function (e, h) {
                ...
                if (f && (f !== b.hoverPoint || g && g.isHidden)) {
                    ...
                    h && g && !g.isHidden && (d = g.getAnchor([{}], e), b.isInsidePlot(d[0], d[1], {
                        visiblePlotOnly: !0
                    }) && g.updatePosition({
                        plotX: d[0],
                        plotY: d[1]
                ...
                a = function () {
                    ...
                    a.prototype.get = function (b) {
                        ...
                        for (var c = this.series,
                                d = da(this.axes, a) || da(this.series, a), e = 0; !d && e < c.length; e++)
                            d = da(c[e].points || [], a);
                        return d
                    };
                    ...
                    a.prototype.temporaryDisplay = function (b) {
                        ...
                        if (b)
                            for (; a && a.style; )
                                a.hcOrigStyle && (N(a, a.hcOrigStyle), delete a.hcOrigStyle), a.hcOrigDetached && (m.body.removeChild(a), a.hcOrigDetached = !1), a = a.parentNode;
                        else
                            for (; a && a.style; ) {
                    ...
                    a.prototype.reflow = function (b) {
                        ...
                        if (!e && !a.isPrinting && h && c && (d === l || d === m)) {
                            if (h !== a.containerWidth || c !== a.containerHeight)
                                p.clearTimeout(a.reflowTimeout), a.reflowTimeout = ba(function () {
                    ...
                    a.prototype.drawChartBox = function () {
                        ...
                        if (e)
                            ...
                            if (v || t["stroke-width"])
                                g.stroke = b.borderColor, g["stroke-width"] = v;
                ...
                a = function () {
                            ...
                            (b.axisTypes || []).forEach(function (e) {
                                ...
                                c[e].forEach(function (c) {
                                    ...
                                    if (a[e] === h && !d.isInternal || "undefined" !== typeof a[e] && a[e] === d.id || "undefined" === typeof a[e] && 0 === d.index)
                                        b.insert(c.series), b[e] = c, c.isDirty = !0;
                                    d.isInternal || h++
                                });
                    ...
                    a.prototype.findPointIndex = function (b,
                        ...
                        var c = b.id,
                                ...
                                g, f;
                        if (c)
                            h = this.chart.get(c), h instanceof E && (g = h);
                        ...
                        b.forEach(function (b, a) {
                            ...
                            if (m.id || N(n)) {
                                if (m = this.findPointIndex(m, p), -1 === m || "undefined" === typeof m ? h.push(b) :
                                        e[m] && b !== c.data[m] ? (e[m].update(b, !1, null, !1), e[m].touched = !0, g && (p = m + 1)) : e[m] && (e[m].touched = !0), !f || a !== m || d && d.enabled || this.hasDerivedData)
                                    k = !0
                            } else
                                h.push(b)
                        }, this);
                        ...
                        if (!t) {
                            ...
                            if (p && v > p)
                                if (x = e.getFirstValidPoint(b), N(x))
                                    for (c = 0; c < v; c++)
                                        n[c] = this.autoIncrement(), q[c] = b[c];
                                else if (S(x))
                                    if (r)
                                        if (x.length === r)
                                            for (c = 0; c < v; c++)
                                            ...
                                            for (c = 0; c < v; c++)
                                                d = b[c], n[c] = d[0], q[c] = d.slice(1, r + 1);
                                    else if (G && (y = G.indexOf("x"), z = G.indexOf("y"), y = 0 <= y ? y : 0, z = 0 <= z ? z : 1), 1 === x.length && (z = 0), y === z)
                                        for (c = 0; c < v; c++)
                                            n[c] = this.autoIncrement(), q[c] = b[c][z];
                                    else
                                        for (c = 0; c < v; c++)
                                            d = b[c], n[c] = d[y], q[c] = d[z];
                                else
                                    D(12, !1, l);
                            else
                                for (c = 0; c < v; c++)
                    ...
                    a.prototype.getProcessedData = function (b) {
                        ...
                        for (d = f.length || 1; --d; )
                            if (a = c ? b(f[d]) - b(f[d - 1]) : f[d] - f[d - 1], 0 < a && ("undefined" === typeof G || a < G))
                                var G = a;
                            else
                    ...
                    a.prototype.processData = function (b) {
                        var a = this.xAxis;
                        if (this.isCartesian &&
                                !this.isDirty && !a.isDirty && !this.yAxis.isDirty && !b)
                            return !1;
                    ...
                    a.prototype.generatePoints = function () {
                        ...
                        if (n && (h !== (m = n.length) || f))
                            for (p = 0; p < m; p++)
                                p !== g || f || (p += h), n[p] && (n[p].destroyElements(), n[p].plotX = void 0);
                        this.data = n;
                        this.points = k;
                    ...
                    a.prototype.animate = function (b) {
                        var a = this.chart,
                                ...
                                l = a.sharedClips[g + "m"];
                        if (b && c)
                            h = this.getClipBox(), f ? f.attr("height", h.height) : (h.width = 0, e && (h.x = a.plotHeight), f = a.renderer.clipRect(h),
                        ...
                        if (c.state !== b && ([c.group, c.markerGroup, c.dataLabelsGroup].forEach(function (a) {
                            ...
                            if (e && !e.dashstyle)
                                ...
                                "stroke-width": l
                                    ...
                                    c["zone-graph-" + k].animate(d, f), k += 1;
                ...
                A(B, "afterSetChartSize", function (a) {
                    ...
                    if (!this.renderer.forExport) {
                        if (e) {
                            ...
                            c && (this.scrollablePixelsY = e = Math.max(0, c - this.chartHeight)) && (this.scrollablePlotBox = this.renderer.scrollablePlotBox = n(this.plotBox), this.plotBox.height = this.plotHeight += e, this.inverted ? this.clipBox.width += e : this.clipBox.height += e, g = {
                                2: {
                                    name: "bottom",
                                    value: e
                                }
            ...
            a[k + "Stacker"] && [c, "-" + c].forEach(function (c) {
                for (var b = g.length, h, d; b--; )
                    if (h = g[b], f = a.getStackIndicator(f, h, a.index,
                            c), d = (h = e[c] && e[c][h]) && h.points[f.key])
                        a[k + "Stacker"](d, h, b)
            })
        };
        ...
        H = function (a) {
            ...
            e.prototype.getGraphPath = function (a) {
                ...
                for (u = 0; u < a.length; u++) {
                    ...
                    if (!d || e)
                        e || l(u, u - 1, "left"), d && !f && e || (x.push(a[u]), y.push({
                            x: u,
                            plotX: D,
                            plotY: v
                        })), e || l(u, u + 1, "right")
            ...
            e.prototype.getStackPoints = function (a) {
                ...
                if (this.options.stacking) {
                    for (var l = 0; l < a.length; l++)
                        a[l].leftNull = a[l].rightNull = void 0, x[a[l].x] = a[l];
                    u(y, function (b, a) {
    ...
    K(f, "Series/Column/ColumnSeries.js", [f["Core/Animation/AnimationUtilities.js"], f["Core/Color/Color.js"], f["Core/Globals.js"], f["Core/Legend/LegendSymbol.js"], f["Core/Series/Series.js"], f["Core/Series/SeriesRegistry.js"],
        ...
        I = function (a) {
            ...
            f.prototype.animate = function (b) {
                ...
                if (b)
                    k.scaleY = .001, b = e(c.toPixels(f.threshold), c.pos, c.pos + c.len), h ? k.translateX = b - c.len : k.translateY = b, a.clipBox && a.setClip(), a.group.attr(k);
                else {
                    var p =
    ...
    K(f, "Series/CenteredUtilities.js", [f["Core/Globals.js"], f["Core/Series/Series.js"], f["Core/Utilities.js"]], function (a, f, B) {
        ...
        (function (a) {
            a.getCenter = function () {
                ...
                for (g = 0; 4 > g; ++g)
                    u = a[g], k = 2 > g || 2 === g && /%$/.test(u), a[g] = I(u, [c, p, t, a[2]][g]) + (k ? e : 0);
                a[3] > a[2] && (a[3] = a[2]);
    ...
    K(f, "Series/Pie/PieSeries.js", [f["Series/CenteredUtilities.js"], f["Series/Column/ColumnSeries.js"], f["Core/Globals.js"], f["Core/Legend/LegendSymbol.js"], f["Series/Pie/PiePoint.js"], f["Core/Series/Series.js"], f["Core/Series/SeriesRegistry.js"], f["Core/Renderer/SVG/Symbols.js"], f["Core/Utilities.js"]], function (a, f, B, H, w, E, I, A, u) {
        ...
        u = function (a) {
            ...
            c.prototype.updateTotals = function () {
                ...
                this.total = b;
                for (f = 0; f < c; f++)
                    g = a[f], g.percentage = 0 < b && (g.visible ||
                ...
                a.visible && (g.enabled || a._hasPointLabels) && (f.forEach(function (a) {
                    ...
                    if (E = c(R.connectorWidth, 1)) {
                        ...
                        if ((K = d.dataLabel) && K._pos && d.visible && 0 < d.labelDistance) {
                            ...
                            if (f = !H)
                                d.connector = H = b.renderer.path().addClass("highcharts-data-label-connector  highcharts-color-" + d.colorIndex + (d.className ? " " + d.className : "")).add(a.dataLabelsGroup), b.styledMode || H.attr({
                                    "stroke-width": E,
            ...
            function w(a) {
                ...
                if (!f) {
                    if (null !== e[0])
                        ...
                        g = Math.max(c[2] - a[1] - a[3], d), c[0] += (a[3] - a[1]) / 2;
    ...
    K(f, "Extensions/OverlappingDataLabels.js", [f["Core/Chart/Chart.js"], f["Core/Utilities.js"]], function (a, f) {
        ...
        a.prototype.hideOverlappingLabels = function (a) {
            ...
            for (g = 0; g < e; g++)
                if (n = a[g])
                    n.oldOpacity = n.opacity, n.newOpacity = 1, n.absoluteBox = u(n);
            a.sort(function (a, c) {
                    ...
                    function c(a, f, g, h) {
                        ...
                        I(a, function (a, d) {
                            if (!h && -1 < e.collectionsWithUpdate.indexOf(d) && f[d])
                                for (a =
                                        u(a), g[d] = [], b = 0; b < Math.max(a.length, f[d].length); b++)
                                    f[d][b] && (void 0 === a[b] ? g[d][b] = f[d][b] : (g[d][b] = {}, c(a[b], f[d][b], g[d][b], h + 1)));
                            else
                                w(a) ? (g[d] = H(a) ? [] : {}, c(a, f[d] || {}, g[d], h + 1)) : g[d] = "undefined" === typeof f[d] ? null : f[d]
                        })
                    }
                    var e = this,
                            f = {};
