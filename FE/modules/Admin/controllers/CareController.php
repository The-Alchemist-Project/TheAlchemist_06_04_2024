<?php
class Admin_CareController  extends Zend_Controller_Action {
		var $tb_post			= "tb_care_post";
		var $tb_config		= "tb_care_config";
		var $tb_cat				= "tb_care_cat";
		var $tb_user			= "tb_user";
		var $page					=	10;
		var $dirImage			=	"files/images/care/";
