<?php
class Admin_ForteController  extends Zend_Controller_Action {
		var $tb_post			= "tb_forte_post";
		var $tb_config		= "tb_forte_config";
		var $tb_cat				= "tb_forte_cat";
		var $tb_user			= "tb_user";
		var $page					=	10;
		var $dirImage			=	"files/images/forte/";
