<?php
class Admin_ParentController  extends Zend_Controller_Action {
		var $tb_post			= "tb_parent_post";
		var $tb_config		= "tb_parent_config";
		var $tb_cat				= "tb_parent_cat";
		var $tb_user			= "tb_user";
		var $page					=	10;
		var $dirImage			=	"files/images/parent/";
    ...
    public function catAction(){
		...
		public function editpostAction() {
			...
			if( $this->isPost ){
				...
				//now upload img if browser
				$config_upload = array(resize => array(330,180));
				if( file_exists( $this->dirImage.$user['img'] ) ){
					$config_upload['oldfile'] = $user['img'];
				}				
